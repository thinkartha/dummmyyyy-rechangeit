            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="Active rules">
                    Active rules
                  </h6>
                  <h3 className="mb-0 text-truncate" data-obs-stat="data-obs-stat" title="19">
                    19
                  </h3>
                </div>
                <span className="badge badge-phoenix text-truncate badge-phoenix-info" style={{ maxWidth: "55%", textTransform: "none" }} title="of 24" data-obs-stat-delta="data-obs-stat-delta">
                  of 24
                </span>
              </div>
            </div>
        ...
        <div className="col-12 col-sm-6 col-xl-3">
          <div className="card h-100">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="Executions (7d)">
                    Executions (7d)
                  </h6>
                  <h3 className="mb-0 text-truncate" data-obs-stat="data-obs-stat" title="412">
                    412
                  </h3>
                </div>
                <span className="badge badge-phoenix text-truncate badge-phoenix-success" style={{ maxWidth: "55%", textTransform: "none" }} title="+64" data-obs-stat-delta="data-obs-stat-delta">
                  +64
                </span>
              </div>
            </div>
            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  ...
                  <h3 className="mb-0 text-truncate" data-obs-stat="data-obs-stat" title="97.1%">
                    97.1%
                  </h3>
                </div>
                <span className="badge badge-phoenix text-truncate badge-phoenix-success" style={{ maxWidth: "55%", textTransform: "none" }} title="+0.6%" data-obs-stat-delta="data-obs-stat-delta">
                  +0.6%
                </span>
              </div>
            </div>
          ...
          <div className="card h-100">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                ...
                <span className="badge badge-phoenix text-truncate badge-phoenix-warning" style={{ maxWidth: "55%", textTransform: "none" }} title="high impact" data-obs-stat-delta="data-obs-stat-delta">
                  high impact
                </span>
              </div>
            </div>
