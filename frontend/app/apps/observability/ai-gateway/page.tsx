            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="AI calls (24h)">
                    AI calls (24h)
                  </h6>
                  <h3 className="mb-0 text-truncate" data-obs-stat="data-obs-stat" title="2.4M">
                    2.4M
                  </h3>
                </div>
                <span className="badge badge-phoenix text-truncate badge-phoenix-success" style={{ maxWidth: "55%", textTransform: "none" }} title="+14%" data-obs-stat-delta="data-obs-stat-delta">
                  +14%
                </span>
              </div>
            </div>
        ...
        <div className="col-12 col-sm-6 col-xl-3">
          <div className="card h-100">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="Rate-limit hits">
                    Rate-limit hits
                  </h6>
                  <h3 className="mb-0 text-truncate" data-obs-stat="data-obs-stat" title="1.8k">
                    1.8k
                  </h3>
                </div>
                <span className="badge badge-phoenix text-truncate badge-phoenix-warning" style={{ maxWidth: "55%", textTransform: "none" }} title="+5%" data-obs-stat-delta="data-obs-stat-delta">
                  +5%
                </span>
              </div>
            </div>
        ...
        <div className="col-12 col-sm-6 col-xl-3">
          <div className="card h-100">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="Fallback activations">
                    Fallback activations
                  </h6>
                  <h3 className="mb-0 text-truncate" data-obs-stat="data-obs-stat" title="312">
                    312
                  </h3>
                </div>
                <span className="badge badge-phoenix text-truncate badge-phoenix-info" style={{ maxWidth: "55%", textTransform: "none" }} title="auto" data-obs-stat-delta="data-obs-stat-delta">
                  auto
                </span>
              </div>
            </div>
        ...
        <div className="col-12 col-sm-6 col-xl-3">
          <div className="card h-100">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="Avg route latency">
                    Avg route latency
                  </h6>
                  <h3 className="mb-0 text-truncate" data-obs-stat="data-obs-stat" title="420ms">
                    420ms
                  </h3>
                </div>
                <span className="badge badge-phoenix text-truncate badge-phoenix-success" style={{ maxWidth: "55%", textTransform: "none" }} title="-35ms" data-obs-stat-delta="data-obs-stat-delta">
                  -35ms
                </span>
              </div>
            </div>
