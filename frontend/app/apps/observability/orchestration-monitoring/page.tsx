            ...
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="Workflows">
                    Workflows
                  </h6>
                  <h3 className="mb-0 text-truncate" data-obs-stat="data-obs-stat" title="164">
                    164
                  </h3>
                </div>
                <span className="badge badge-phoenix text-truncate badge-phoenix-info" style={{ maxWidth: "55%", textTransform: "none" }} title="+9" data-obs-stat-delta="data-obs-stat-delta">
                  +9
                </span>
              </div>
            </div>
        ...
        <div className="col-12 col-sm-6 col-xl-3">
          <div className="card h-100">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="Runs (24h)">
                    Runs (24h)
                  </h6>
                  <h3 className="mb-0 text-truncate" data-obs-stat="data-obs-stat" title="3,428">
                    3,428
                  </h3>
                </div>
                <span className="badge badge-phoenix text-truncate badge-phoenix-success" style={{ maxWidth: "55%", textTransform: "none" }} title="+184" data-obs-stat-delta="data-obs-stat-delta">
                  +184
                </span>
              </div>
            </div>
        ...
        <div className="col-12 col-sm-6 col-xl-3">
          <div className="card h-100">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="Failed runs">
                    Failed runs
                  </h6>
                ...
                <span className="badge badge-phoenix text-truncate badge-phoenix-warning" style={{ maxWidth: "55%", textTransform: "none" }} title="+6" data-obs-stat-delta="data-obs-stat-delta">
                  +6
                </span>
              </div>
            </div>
        ...
        <div className="col-12 col-sm-6 col-xl-3">
          <div className="card h-100">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start gap-2">
                <div style={{ minWidth: "0" }}>
                  <h6 className="text-body-tertiary mb-2 text-truncate" title="Queued > SLA">
                    Queued &gt; SLA
                  </h6>
                ...
                <span className="badge badge-phoenix text-truncate badge-phoenix-danger" style={{ maxWidth: "55%", textTransform: "none" }} title="waiting on slots" data-obs-stat-delta="data-obs-stat-delta">
                  waiting on slots
                </span>
              </div>
            </div>
