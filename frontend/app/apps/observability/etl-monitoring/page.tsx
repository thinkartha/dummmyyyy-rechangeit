...
export default function Page() {
  return (
    <AppLayout scripts={[
      ...
      <div className="obs-list-root" data-list={"{\"valueNames\":[\"col0\",\"col1\",\"col2\",\"col3\",\"col4\",\"col5\",\"col6\"],\"page\":10,\"filter\":{\"key\":\"col6\"}}"} data-live-table="etlJobs">
        <div className="card">
          <div className="card-header border-bottom border-translucent py-3">
            <div className="row align-items-center g-2 mb-3">
              <div className="col">
                ...
                <p className="text-body-tertiary fs-9 mb-0">
                  Latest state per execution across every connected platform — connect a platform and poll it to populate
                </p>
              </div>
            </div>
            <div className="row align-items-center g-2">
              <div className="col-12 col-md">
                <div className="search-box w-100">
                  <form className="position-relative">
                    <input className="form-control search-input search form-control-sm" type="search" placeholder="Search jobs, platforms, or environments" aria-label="Search" />
                    <span className="fas fa-search search-box-icon"></span>
                  </form>
                </div>
              </div>
