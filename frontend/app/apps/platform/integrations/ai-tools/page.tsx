    ...
    <AppLayout scripts={[
      ...
      <div className="card mb-4">
        <div className="card-body">
          <h4 className="mb-2">
            How AI telemetry arrives
          </h4>
          <p className="text-body-tertiary fs-9">
            Two paths, and neither needs a button on the monitoring page:
          </p>
          <ul className="fs-9 mb-0">
            <li>
              The AI gateway reports calls that pass through it — nothing to register.
            </li>
            <li>
              A tool that does not sit behind the gateway pushes to the telemetry endpoint, which only accepts calls carrying an agent key. Registering here mints that key — it is shown once.
            </li>
          </ul>
        </div>
      </div>
            ...
            <div className="row align-items-center g-2 mb-3">
              <div className="col">
                ...
                <p className="text-body-tertiary fs-9 mb-0">
                  Agents this organization registered, and what they have reported
                </p>
              </div>
            </div>
              ...
              <div className="col-12 col-md">
                <div className="search-box w-100">
                  <form className="position-relative">
                    <input className="form-control search-input search form-control-sm" type="search" placeholder="Search agents" aria-label="Search" />
                  ...
                  <tr>
                    <td className="align-middle ps-3 py-3 col0">
                      <div className="d-flex align-items-center">
                        <span className="me-2 fa-solid fa-robot text-secondary"></span>
                        <div>
                          <h6 className="mb-0">
                            —
                          </h6>
