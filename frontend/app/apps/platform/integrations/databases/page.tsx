      ...
      <div className="card mb-4">
        <div className="card-body">
          ...
          <p className="text-body-tertiary fs-9 mb-0">
            The connection string is held server-side under this organization and never returned to the browser once saved. "Test connection" in the add dialog dials it first, so a typo fails before it becomes a registration.
          </p>
        </div>
      </div>
          ...
          <div className="card-header border-bottom border-translucent py-3">
            <div className="row align-items-center g-2 mb-3">
              <div className="col">
                ...
                <p className="text-body-tertiary fs-9 mb-0">
                  Every engine this organization watches
                </p>
              </div>
            </div>
